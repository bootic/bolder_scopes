...
RSpec.describe Bootic::Scopes::Tree do
  specify 'declaring and accessing allowed scope hierarchies' do
    ...
    }.to raise_error(Bootic::Scopes::Tree::InvalidScopeHierarchyError)
    ...
    expect(scope).to be_a(Bootic::Scopes::Scope)
  ...
  specify do
    tree = Bootic::Scopes::Tree.new('bootic') do |bootic|
      integer = /^\d+$/
